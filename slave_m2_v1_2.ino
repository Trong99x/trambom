/*****************************************************************
 * SLAVE MOONG 2 NODE — ESP32 + SX1278
 * VERSION 1.2 — BAT CRC + GIAM BLOCKING + LECH PHA HEARTBEAT
 *
 * FILE NAY DA CO DINH SLAVE_ID = 2 (Moong 2) — nap thang, khong can
 * chinh gi them. File Moong 1 la mot file rieng (slave_m1_v1_2.ino).
 *
 * SUA TU V1.1:
